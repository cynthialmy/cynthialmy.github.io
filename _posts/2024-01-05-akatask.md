...
This case study documents how I turned a messy, emotionally charged problem space into a shipped iOS app. The research that informed this product is covered in [Navigating Parenthood: Product Preferences and Parental Challenges](https://cynthialmy.github.io/2024-01-03-new-parents/). This piece picks up where research ended: translating validated insights into a product with clear scope, measurable targets, and deliberate constraints on where AI belongs in the workflow.
...
The competitive landscape had two well-established players occupying vertical slices of the parenting experience. Neither addressed the horizontal coordination layer.
...
**Virality mechanics:** Partner sync (share task lists with a co-parent) and referral rewards leverage the app's natural two-person use case. Most parenting apps are single-user tools. Making sharing a first-class feature creates organic distribution.
